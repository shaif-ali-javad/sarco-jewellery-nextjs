...
function page() {
  return (
    ...
    <div className='m-auto mt-10'>
      ...
      <h1 className="md:text-7xl text-3xl lg:text-4xl font-medium text-center text-white relative z-20">
      ABOUT US
      </h1>
      <div className="w-[40rem] h-10 relative">
        ...
        <p className='font-medium text-4xl mb-3 text-neutral-400'></p>
