...
function page() {
  return (
    <div className='py-12 pt-36 text-white p-5 dark:bg-black bg-white dark:bg-grid-white/[0.2] bg-grid-black/[0.2]'>
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-items-center'>
      ...
      <div className='p-6 m-auto'>
        ...
        <p className='text-neutral-500'>Building on this legacy and its extensive expertise in gold trading, Noha gold assures to provide you with various safe and secure solutions to invest physically in high-end bars of both gold and silver bullion, coming from our refinery, and from the world’s leading bullion brands. 
        <br /><br />
