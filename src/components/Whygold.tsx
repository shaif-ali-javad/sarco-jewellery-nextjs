    ...
    <div className="min-h-screen bg-black pt-20">
      <div className="py-10">
        <div className="p-5">
          ...
          <div>
            <h3 className="text-4xl font-bold darktext-white">A HISTORY OF HOLDING VALUE</h3>
          ...
          <div>
            <h3 className="text-4xl font-bold darktext-white">PORTFOLIO DIVERSIFICATION</h3>
            <p className="py-6 text-neutral">
            Properly diversified investment portfolios combine gold with stocks and bonds to reduce the overall volatility and risks.
            </p>
          </div>
          <div>
            <h3 className="text-4xl font-bold darktext-white">LONG-TERM VALUE</h3>
            <p className="py-6 text-neutral">
