                ...
                {featuredCourses.map((course:Course) => (
                    <div key={course.id} className="flex justify-center">
                        ...
                        <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                                <p className="text-lg sm:text-xl text-black mt-4 mb-2 text-neutral-200">{course.title}</p>
                                <p className="text-sm text-neutral-600 text-neutral-400 flex-grow">{course.description}</p>
